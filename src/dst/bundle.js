...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)(function () {
	    (0, _jquery2.default)(".cat").each(function (index) {

	        (0, _jquery2.default)(this).children(".title").first().text(catTitles[index]);

	        (0, _jquery2.default)(this).children("img").click(function () {
	            var currentCounter = parseInt((0, _jquery2.default)(this).siblings(".counter").first().text());
	            console.log("currentCounter is -> " + currentCounter);
	            (0, _jquery2.default)(this).siblings(".counter").first().text(currentCounter + 1);
	        });
	    });
	});
